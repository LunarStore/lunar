...
namespace lunar {
    ...
    static lunar::ConfigVar<std::string>::ptr g_module_path
        = ConfigVarMgr::GetInstance()->lookUp("module.path", std::string("module"), "module path");
    ...
    bool Module::onConnect(lunar::Stream::ptr stream) {
        return true;
    }

    bool Module::onDisconnect(lunar::Stream::ptr stream) {
        return true;
    }
