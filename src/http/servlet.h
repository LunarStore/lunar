 ...
 * CreateTime : 2023-03-02 17:00
 * LastModified : 2023-03-02 17:00
 * Filename : httpservlet.h
 * Description : 1.0 *
 ************************************/

#ifndef __LUNAR_SERVLET_H__
#define __LUNAR_SERVLET_H__
...
namespace lunar {
    namespace http {
        ...
        public:
             ...
             * @return 是否处理成功
             */
            virtual int32_t handle(lunar::http::HttpRequest::ptr request
                        , lunar::http::HttpResponse::ptr response
                        , lunar::http::HttpSession::ptr session) = 0;
        ...
        public:
            ...
            /// 函数回调类型定义
            typedef std::function<int32_t (lunar::http::HttpRequest::ptr request
                        , lunar::http::HttpResponse::ptr response
                        , lunar::http::HttpSession::ptr session)> callback;
            ...
            virtual int32_t handle(lunar::http::HttpRequest::ptr request
                        , lunar::http::HttpResponse::ptr response
                        , lunar::http::HttpSession::ptr session) override;
        private:
            /// 回调函数
            callback m_cb;
        };
